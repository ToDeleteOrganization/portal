...
import com.evozon.evoportal.myaccount.builder.validators.AbstractValidator;
...
public class UserAccountValidation extends AbstractValidator {
	...
	private boolean isDateHiredInBusinessDay(ActionRequest actionRequest) {
		boolean isDateHiredInBusinessDay = true;
		...
		if (hiredDateCal != null) {
			if (isWeekendDay(hiredDateCal)) {
				isDateHiredInBusinessDay = false;
			}
