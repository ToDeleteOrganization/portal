...
/* TODO: firstDayOfWeek is HARDCODED - just a reminder. Have a nice day!
* Set for ALL calendars first day of the week to be MONDAY.
*
*  Reason:
*      Kaleo Forms use default firstDayOfWeek for it's calendar inputs.
*      Another workaround to that is to change "portal-impl.jar\com\liferay\portlet\dynamicdatamapping\dependencies\ddm\date.ftl" through ext or by hand.
*
*  FirstDayOfWeek value is CAENDAR.MONDAY - 1, because Liferay substracts 1 for cleaner code.(check tag implementation com.liferay.taglib.ui.InputDateTag)
*
* */
