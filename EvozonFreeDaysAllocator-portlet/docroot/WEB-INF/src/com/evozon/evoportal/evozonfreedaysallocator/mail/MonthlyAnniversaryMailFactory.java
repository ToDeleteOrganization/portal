...
public class MonthlyAnniversaryMailFactory implements AllocatorMailFormatFactory {

	private static final Logger log = Logger.getLogger(MonthlyAnniversaryMailFactory.class);
	...
	public MonthlyAnniversaryMailFactory(final List<BenefitDayQueue> queuedDays, final List<User> usersToSend) {
